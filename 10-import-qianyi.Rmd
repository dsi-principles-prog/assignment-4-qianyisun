...
*Note: I want to request that score for these sections replace your score for the coding portion of Assignment 3.*
# Library package
```{r library_packages}
library(tidyverse)
library(assertr)
...
My main goal is to solve the problem that how the attributes of App contribute the user ratings. Finally I can give some advice to application inventor to help them obtain higher user satisfaction.
...
# 3. Clean up the data
After finishing last procedure, I found that the dataset is very clean. Thus I do some changes on type conversion and 
